...
import com.suan.util.camera.FrameManager;
...
public class MyCameraView extends View {
	...
	public MyCameraView(Context context, LayoutParams layoutParams) {
		super(context, null);
...
//		Log.e("center", ReconitionManager.centerAreaItem + "");
		...
		if(FrameManager.captuerColorList.size()>0){
			paint.setColor((int)FrameManager.captuerColorList.get(FrameManager.captuerColorList.size()-1)[0]);
			canvas.drawCircle(getWidth()/2, getHeight()/2, 50, paint);
		}

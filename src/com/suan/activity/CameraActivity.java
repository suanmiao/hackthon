...
public class CameraActivity extends Activity {
	...
	protected void onResume() {
		...
		myCameraView = new MyCameraView(this, new LayoutParams(previewLayout.getWidth(),
				previewLayout.getHeight()));
		RelativeLayout.LayoutParams layoutParams = new LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);

		previewLayout.addView(mPreview, layoutParams);
		previewLayout.addView(myCameraView, layoutParams);
	}
	...
	protected void onPause() {
		...
		previewLayout.removeView(myCameraView);
